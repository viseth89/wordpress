...
function lapizzeria_styles()
{
	...
	wp_register_script('googlemaps', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDha_pVAWhqofwbQMnGySJF694HXnLjRk8&callback=initMap', array(), '', true);
